...
gTextures = {
    ...
    ['green-alien'] = love.graphics.newImage('graphics/coeli.png'),
...
gFonts = {
    ...
    ['medium'] = love.graphics.newFont('fonts/LEVIBRUSH.ttf', 18),
    ['large'] = love.graphics.newFont('fonts/LEVIBRUSH.ttf', 32),
